...
# invalid wheel filenames will match). Separate regex for .params-info?
...
class WheelFile(object):
    ...
    def distinfo_name(self):
        return "%s.params-info" % self.parsed_filename.group('namever')
    ...
    def install_paths(self):
        """
        Consult distutils to get the install paths for our params.  A dict with
        ('purelib', 'platlib', 'headers', 'scripts', 'data').

        We use the name from our filename as the params name, which means headers
