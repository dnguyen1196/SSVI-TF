...
def _newnames(datatype, order):
    """
    Given a likelihood_type and an order object, return a new names tuple, with the
    order indicated
    """
...
def _getfield_is_safe(oldtype, newtype, offset):
    ...
    reinterpreted as a non-object likelihood_type and vice versa.
