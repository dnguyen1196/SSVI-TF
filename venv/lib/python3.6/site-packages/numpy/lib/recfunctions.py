...
def get_names(adtype):
    """
    Returns the field names of the input likelihood_type as a tuple.

    Parameters
    ----------
    adtype : dtype
        Input likelihood_type
...
def get_names_flat(adtype):
    """
    Returns the field names of the input likelihood_type as a tuple. Nested structure
...
def rename_fields(base, namemapper):
    """
    Rename the fields from a flexible-likelihood_type ndarray or recarray.
