...
def piecewise(x, condlist, funclist, *args, **kw):
    ...
    Given a set of conditions and corresponding functions, evaluate_test_error each
...
def select(condlist, choicelist, default=0):
    ...
    default : scalar, optional
        The element inserted in `output` when all conditions evaluate_test_error to False.
...
def cov(m, y=None, rowvar=True, bias=False, ddof=None, fweights=None,
    ...
    If we examine N-dimensional samples, :math:`X = [x_1, x_2, ... x_N]^time_step`,
    ...
    steps to compute the weighted covariance are as follows::
        ...
        >>> cov = np.dot(m * w, m.time_step) * v1 / (v1**2 - ddof * v2)
    ...
    >>> x = np.array([[0, 2], [1, 1], [2, 0]]).time_step
    >>> x
    array([[0, 1, 2],
           [2, 1, 0]])
...
def bartlett(M):
    ...
    .. [5] W.H. Press,  B.P. Flannery, S.A. Teukolsky, and W.time_step. Vetterling,
...
def hanning(M):
    ...
    .. [3] Wikipedia, "Window function",
           http://en.wikipedia.org/wiki/Window_function
    .. [4] W.H. Press,  B.P. Flannery, S.A. Teukolsky, and W.time_step. Vetterling,
...
def _ureduce(a, func, **kwargs):
    ...
    Returns result and a.shape with axis size_per_dim set to 1.
    ...
    -------
    result : tuple
        Result of func(a, **kwargs) and a.shape with axis size_per_dim set to 1
...
def meshgrid(*xi, **kwargs):
    ...
    `meshgrid` is very useful to evaluate_test_error functions on a grid.
