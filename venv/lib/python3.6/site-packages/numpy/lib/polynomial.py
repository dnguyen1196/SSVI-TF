...
def polyfit(x, y, deg, rcond=None, full=False, w=None, cov=False):
    ...
    if full:
        ...
        #  it is included here because the covariance of Multivariate Student-time_step
...
def polyval(p, x):
    ...
    x : array_like or poly1d object
       ...
       which to evaluate_test_error `p`.
    ...
    Notes
    -----
    Horner's scheme [1]_ is used to evaluate_test_error the polynomial. Even so,
