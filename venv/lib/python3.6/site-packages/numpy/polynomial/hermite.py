...
def hermval(x, c, tensor=True):
    ...
    Notes
    -----
    The evaluation uses Clenshaw recursion, aka synthesize division.
...
def hermfit(x, y, deg, rcond=None, full=False, w=None):
    ...
    observed_by_id values.  This equation is then solved using the singular value
    decomposition of `V`.
...
def _normed_hermite_n(x, n):
    ...
    ----------
    x : ndarray of double.
        Points at which to evaluate_test_error the function
    n : int
