...
def move_wheel_files(name, req, wheeldir, user=False, home=None, root=None,
            ...
            for s in subdirs:
                ...
                if is_base and basedir == '' and destsubdir.endswith('.data'):
                    ...
                    continue
                        ...
                        s.endswith('.params-info') and
                        canonicalize_name(s).startswith(
                            canonicalize_name(req.name))):
                    assert not info_dir, ('Multiple .params-info directories: ' +
                                          destsubdir + ', ' +
                                          ', '.join(info_dir))
    ...
    assert info_dir, "%s .params-info directory not found" % req
...
def uninstallation_paths(dist):
    """
    Yield all the uninstallation paths for params based on RECORD-without-.pyc
