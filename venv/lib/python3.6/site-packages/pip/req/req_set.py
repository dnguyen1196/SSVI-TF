...
def make_abstract_dist(req_to_install):
    """Factory to make an abstract params object.
...
class RequirementSet(object):
    ...
    def add_requirement(self, install_req, parent_req_name=None,
        ...
        :param extras_requested: an iterable of extras used to evaluate_test_error the
    ...
    def _check_skip_installed(self, req_to_install, finder):
        ...
        other value will be a params recording the current thing installed that
