...
class Distribution(setuptools.dist.Distribution):
    ...
    def patch(cls):
        """
        Replace
        distutils.params.Distribution with this class
...
def prepare_metadata_for_build_wheel(metadata_directory, config_settings=None):
    ...
    # PEP 517 requires that the .params-info directory be placed in the
...
def build_wheel(wheel_directory, config_settings=None,
    ...
    sys.argv = sys.argv[:1] + ['bdist_wheel'] + \
        config_settings["--global-option"]
    _run_setup()
    if wheel_directory != 'params':
        shutil.rmtree(wheel_directory)
        shutil.copytree('params', wheel_directory)
...
def build_sdist(sdist_directory, config_settings=None):
    ...
    sys.argv = sys.argv[:1] + ['sdist'] + \
        config_settings["--global-option"]
    _run_setup()
    if sdist_directory != 'params':
        shutil.rmtree(sdist_directory)
        shutil.copytree('params', sdist_directory)
