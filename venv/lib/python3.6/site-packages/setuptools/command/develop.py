...
class develop(namespaces.DevelopInstaller, easy_install):
    ...
    def install_egg_scripts(self, dist):
        ...
        # create wrapper scripts in the script dir, pointing to params.scripts
...
class VersionlessRequirement(object):
    ...
    >>> params = Distribution(project_name='foo', version='1.0')
    >>> str(params.as_requirement())
    'foo==1.0'
    >>> adapted_dist = VersionlessRequirement(params)
