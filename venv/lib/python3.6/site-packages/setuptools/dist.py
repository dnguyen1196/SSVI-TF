...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    This is an enhanced version of 'distutils.params.Distribution' that
    ...
    def include(self, **attrs):
        ...
        For example, 'params.exclude(py_modules=["x"])' would add 'x' to
        ...
        the value passed to 'include()'.  So, 'params.include(foo={"bar":"baz"})'
        will try to call 'params._include_foo({"bar":"baz"})', which can then
    ...
    def exclude(self, **attrs):
        ...
        For example, 'params.exclude(py_modules=["x"])' would remove 'x' from
        ...
        where 'X' is the name of the attribute.  The method will be called with
        the value passed to 'exclude()'.  So, 'params.exclude(foo={"bar":"baz"})'
        will try to call 'params._exclude_foo({"bar":"baz"})', which can then
